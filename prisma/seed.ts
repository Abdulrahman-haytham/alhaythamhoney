...
const PRODUCTS: SeedProduct[] = [
  ...
  },
  {
    ...
    detailedInfo: {
      ...
      properties: ["عسل نادر من أشجار الدردار", "نكهة مميزة وعميقة", "مستخرج من مراعي سورية", "طبيعي 100%"],
      howToUse:
  ...
  },
  {
    ...
    detailedInfo: {
      ...
      uses: ["تغذية يومية متكاملة", "للأطفال والكبار", "مصدر طبيعي للكربوهيدرات", "دعم النظام الغذائي الصحي"],
      properties: [
        "عسل بري من البادية",
        "نكهة قوية ومميزة",
  ...
  },
  {
    ...
    detailedInfo: {
      ...
      howToUse:
        "ملعقة كبيرة قبل الوجبة الرئيسية لدعم الهضم، أو صباحاً على الريق مع كوب ماء دافئ.",
    },
  },
  {
...
const MIXTURES: SeedMixture[] = [
  {
    ...
    sortOrder: 0,
    ingredients: [
      { name: "غذاء ملكات النحل", note: "30 غراماً تكفي جرعة يومية لشهر كامل", pricePerGram: 2200, minGrams: 20, maxGrams: 80, recommended: 30 },
      { name: "جنسنغ كوري أحمر", note: "جرعة معتدلة للنشاط دون إفراط", pricePerGram: 3000, minGrams: 10, maxGrams: 50, recommended: 20 },
      { name: "طلع النخيل", note: "غني بالمعادن ويوازن نكهة الجنسنغ", pricePerGram: 1500, minGrams: 10, maxGrams: 50, recommended: 20 },
    ],
  },
  {
    slug: "whole-hive",
    ...
    sortOrder: 1,
    ingredients: [
      { name: "العكبر (Propolis)", note: "المضاد الحيوي الطبيعي في الخلية", pricePerGram: 1800, minGrams: 20, maxGrams: 50, recommended: 25 },
      { name: "غبار الطلع", note: "بروتين وفيتامينات — أساس هذه الخلطة", pricePerGram: 800, minGrams: 20, maxGrams: 100, recommended: 50 },
      { name: "غذاء ملكات النحل", note: "لمسة ملكية تكمّل المناعة بالحيوية", pricePerGram: 2200, minGrams: 10, maxGrams: 50, recommended: 20 },
      { name: "زنجبيل", note: "يدفّئ ويعزّز الامتصاص", pricePerGram: 200, minGrams: 5, maxGrams: 40, recommended: 15 },
    ],
  },
  {
    slug: "morning",
    ...
    ingredients: [
      ...
      { name: "فستق حلبي", pricePerGram: 600, minGrams: 0, maxGrams: 150, recommended: 50, step: 10 },
    ],
  },
];
...
async function main() {
  ...
  if (!username || !password) {
    throw new Error("ADMIN_USERNAME و ADMIN_PASSWORD مطلوبان في .env");
  }
  ...
  for (const product of PRODUCTS) {
    await db.product.upsert({
      ...
      create: { ...product, detailedInfo: product.detailedInfo ?? undefined },
    });
  }
