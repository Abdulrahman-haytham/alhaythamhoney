...
// Explicit opt-in to an isolated local test database; never run against deployment data.
...
describe.skipIf(!url)('commercial workflow on PostgreSQL', () => {
  ...
  it('saves one order across simultaneous retries, including zero legacy stock, and replays its original quote', async () => {
