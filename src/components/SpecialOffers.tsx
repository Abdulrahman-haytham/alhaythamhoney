 ...
 * محتوى حقيقي منقول من النسخة القديمة، وليس مرتبطاً بقاعدة البيانات
 * لأنه تسويقي بطبيعته (خصم جملة، باقة عائلة، اشتراك شهري) لا "منتج"
 * له سجل في جدول Product.
 */
const offers = [
  {
    id: 1,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {offers.map((offer, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/0 via-amber-500/0 to-amber-500/0 group-hover:from-amber-500/20 group-hover:via-amber-500/10 group-hover:to-amber-500/0 transition-all duration-700" />
              ...
              <div className="relative z-10">
                ...
                <div className="mb-5 flex justify-center">
                  <div className="p-3 bg-amber-500/15 rounded-2xl border border-amber-500/25 group-hover:bg-amber-500/25 transition-all duration-300">
                    <offer.icon className="w-8 h-8 text-amber-500" />
                  </div>
                </div>
              ...
              {/* Decorative Elements */}
              <div className="absolute top-0 left-0 w-20 h-20 border-t border-l border-amber-500/15 rounded-tl-3xl" />
              <div className="absolute bottom-0 right-0 w-20 h-20 border-b border-r border-amber-500/15 rounded-br-3xl" />
            </Reveal>
          ))}
        </div>
