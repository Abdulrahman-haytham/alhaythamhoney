  ...
  return (
    ...
    >
      ...
      <LegalSection title="استخدام الموقع والملكية الفكرية">
        <p>
          جميع النصوص والصور والتصاميم المنشورة على الموقع مملوكة لـ{SITE.name}. لا يجوز إعادة نشرها
          أو استخدامها تجارياً دون إذن خطي مسبق.
        </p>
        <p>يُمنع استخدام الموقع بأي شكل يضر بعمله أو بأمنه أو ينتهك القوانين النافذة.</p>
      </LegalSection>

      <LegalSection title="حدود المسؤولية">
        <p>
          نبذل جهدنا لدقة المعلومات المعروضة، لكننا لا نضمن خلوّها من الأخطاء المطبعية. مسؤوليتنا في
          جميع الأحوال محدودة بقيمة الطلب المدفوعة.
        </p>
      </LegalSection>
      ...
      <LegalSection title="القانون الواجب التطبيق والتواصل">
        <p>
          ...
          <a
            href={getWhatsAppLink('مرحباً، لدي استفسار عن الشروط والأحكام.')}
            target="_blank"
