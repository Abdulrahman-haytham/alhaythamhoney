 ...
 */
/** عناكب البحث والأدوات الآلية تضخّم العدّادات — تُستبعد قبل الكتابة. */
const BOT =
  /bot|crawl|spider|slurp|facebookexternalhit|headless|preview|monitor|curl|wget|python|axios|lighthouse/i;
