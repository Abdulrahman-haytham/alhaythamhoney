...
/** استخدام الكوبون يُسجَّل داخل معاملة الطلب وحدها — لا ينفع نداء من المتصفح. */
export async function PUT() {
  return NextResponse.json({ error: 'استخدام الكوبون يتم مع تسجيل الطلب فقط.' }, { status: 410 });
}
