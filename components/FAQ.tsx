...
const faqData = [
  {
    question: "كيف يمكنني الوثوق بجودة عسل الهيثم؟",
    answer: (
      <>
        نحن لا نبيع منتجًا، بل نشاركك إرثًا. عسل <span className="text-amber-500 font-bold">الهيثم</span> يُنتج من مناحلنا الخاصة في بيئات نظيفة وتحت إشراف مباشر، ويُعبّأ في ظروف مثالية تحفظ خصائصه الطبيعية. نحن لا نقدّم ادّعاءات، بل تاريخاً من الثقة منذ 1997، وتجربة يتذوّقها عملاؤنا.
      </>
    )
  },
  {
    question: "هل تبلور العسل يعني أنه فاسد أو مغشوش؟",
    answer: "على العكس تمامًا. تبلور العسل هو ظاهرة طبيعية تحدث للعسل الخام غير المعالج حراريًا، وتدلّ غالبًا على نقائه. يمكنك إعادته لحالته السائلة بوضع العبوة في ماء فاتر (وليس ساخنًا) دون غليان."
  },
  {
    question: "كيف يتم شحن المنتجات داخل سوريا؟",
    answer: "نوفّر شحنًا سريعًا وآمنًا إلى جميع المحافظات السورية، باستخدام عبوات محكمة التغليف تحافظ على جودة العسل أثناء النقل. عادةً يصل الطلب خلال 2 إلى 4 أيام عمل حسب موقعك."
  },
  {
    question: "هل يمكنني طلب خلطة مخصصة لحالتي الصحية؟",
    answer: "نعم، نوفّر خلطات خاصة مصمّمة حسب احتياجك، باستخدام مكوّنات طبيعية مثل: غذاء ملكات النحل، العكبر (Propolis)، حبوب اللقاح، والزنجبيل. ننصحك بالتواصل معنا عبر واتساب لتحديد الحالة الصحية وهدف الاستخدام."
  },
  {
    question: "ما هي سياسة الاسترجاع لديكم؟",
    answer: "في حال استلام منتج تالف أو مخالف للمواصفات، نلتزم بالتعويض الكامل أو الاستبدال دون أي تكلفة إضافية. رضاك هو الضمان الوحيد الذي نعترف به."
  },
  {
