        ...
        >
          ...
          <div className="p-4 sm:p-6 md:p-8 flex flex-col flex-grow">
            ...
            <div className="flex gap-2 mt-auto pt-4 border-t border-white/5">
              <Link
                to={`/product/${item.id}`}
                className="flex items-center justify-center gap-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 group/btn flex-1"
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 bg-amber-500 hover:bg-amber-400 text-zinc-950 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40 hover:-translate-y-0.5 flex-1"
